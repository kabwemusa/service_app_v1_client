  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      if (res.mfa_required && res.mfa_partial_token) {
        ...
        document.cookie = `admin_mfa_partial=${encodeURIComponent(res.mfa_partial_token)}; path=/; max-age=300; SameSite=Lax`
      ...
      if (res.token) {
        ...
        document.cookie = `${ADMIN_TOKEN_COOKIE}=${encodeURIComponent(res.token)}; path=/; max-age=${60 * 60 * 8}; SameSite=Lax${secure}`
      }
